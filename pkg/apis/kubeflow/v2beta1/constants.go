...
const (
	...
	// MPIJobRetryCountLabel represents the number of times we have retried a MPIJob upon failures.
	MPIJobRetryCountLabel = "training.kubeflow.org/retry-count"
	// MPIJobRetryCountLimitLabel represents the maximum number of times we can retry a MPIJob upon failures.
