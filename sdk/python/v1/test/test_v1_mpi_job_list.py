...
import mpijob
from mpijob.models.v1_mpi_job_list import V1MPIJobList  # noqa: E501
...
class TestV1MPIJobList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = mpijob.models.v1_mpi_job_list.V1MPIJobList()  # noqa: E501
        if include_optional :
            return V1MPIJobList(
                api_version = '', 
                items = [
                    mpijob.models.v1/mpi_job.v1.MPIJob(
                        api_version = '', 
                        kind = '', 
                        metadata = None, 
                        spec = mpijob.models.v1/mpi_job_spec.v1.MPIJobSpec(
                            clean_pod_policy = '', 
                            main_container = '', 
                            mpi_replica_specs = {
