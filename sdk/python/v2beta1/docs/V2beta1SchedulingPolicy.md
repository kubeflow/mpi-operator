...
**min_resources** | **dict(str, object)** | MinResources defines the minimal resources of members to run the PodGroup. If the gang-scheduling isn&#39;t empty, input is passed to &#x60;.spec.minResources&#x60; in PodGroup for scheduler-plugins. | [optional] 
