...
func (c *FakeMPIJobs) Get(name string, options v1.GetOptions) (result *v2.MPIJob, err error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) List(opts v1.ListOptions) (result *v2.MPIJobList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) Create(mPIJob *v2.MPIJob) (result *v2.MPIJob, err error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) Update(mPIJob *v2.MPIJob) (result *v2.MPIJob, err error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) UpdateStatus(mPIJob *v2.MPIJob) (*v2.MPIJob, error) {
	obj, err := c.Fake.
...
func (c *FakeMPIJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.MPIJob, err error) {
	obj, err := c.Fake.
