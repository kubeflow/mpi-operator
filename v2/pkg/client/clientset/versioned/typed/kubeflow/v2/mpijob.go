...
type MPIJobInterface interface {
	Create(*v2.MPIJob) (*v2.MPIJob, error)
	Update(*v2.MPIJob) (*v2.MPIJob, error)
	UpdateStatus(*v2.MPIJob) (*v2.MPIJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v2.MPIJob, error)
	List(opts v1.ListOptions) (*v2.MPIJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.MPIJob, err error)
	MPIJobExpansion
}
...
func (c *mPIJobs) Get(name string, options v1.GetOptions) (result *v2.MPIJob, err error) {
	result = &v2.MPIJob{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) List(opts v1.ListOptions) (result *v2.MPIJobList, err error) {
...
func (c *mPIJobs) Create(mPIJob *v2.MPIJob) (result *v2.MPIJob, err error) {
	result = &v2.MPIJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Update(mPIJob *v2.MPIJob) (result *v2.MPIJob, err error) {
	result = &v2.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) UpdateStatus(mPIJob *v2.MPIJob) (result *v2.MPIJob, err error) {
	result = &v2.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.MPIJob, err error) {
	result = &v2.MPIJob{}
